...
export async function GET(req: Request, res: Response){
    ...
    if (!isPasswordMatching) { return unauthorized(rm001009) }
    ...
    if (!isTFAMatching) { return unauthorized(rm001009) }
    if (Number(accountFound.status) <= 0) { return unauthorized(rm001010) }
