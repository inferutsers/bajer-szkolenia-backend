...
export async function POST(req: Request, res: Response){
    ...
    const insteredCourseArray = await db.query('INSERT INTO "courses"("date", "title", "place", "instructor", "note", "price", "span", "slots", "available") VALUES ($1, $2, $3, $4, $5, $6, $7, $8, true) RETURNING *', [date, title, place, instructor, note, price, span, slots])
