...
export async function PATCH(req: Request, res: Response){
    ...
    const changedNewsArray = await db.query('UPDATE "news" SET "title" = $1, "description" = $2, "date" = $3, "pin" = $4, "image" = $5 WHERE "id" = $6 RETURNING *', [utf8.decode(title), utf8.decode(description), date, pin, imageBuffer, newsID])
