...
export async function POST(req: Request){
    ...
    if (signup.courseID && !signup.offerID) { //COURSE
        ...
        if(signupConfirmation.mailSent == true) { systemLog(systemAction.ADMresendSignupConfirmation, systemActionStatus.success, `Wysłano ponowne potwierdzenie dla zapisu #${signup.id}`, validatedUser, db); return Response.json(null, {status: 200}) }
