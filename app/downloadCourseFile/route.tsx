...
export async function GET(req: NextRequest, res: Response){
    ...
    if (fileExtension == "pdf") { 
        return NextResponse.json({name: newFileName, file: await generateSecurePDF(courseFile, newFileName, course)}, {status: 200})
    }
    return NextResponse.json({name: newFileName, file: courseFile}, {status: 200})
}