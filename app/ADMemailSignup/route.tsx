...
export async function POST(req: Request, res: Response){
    ...
    if (signup.permissionRequired > validatedUser.status) { systemLog(systemAction.ADMemailSignup, systemActionStatus.error, rm001000, validatedUser, db); return unauthorized(rm001000) }
