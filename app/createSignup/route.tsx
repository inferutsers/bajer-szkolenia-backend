...
export async function POST(req: Request, res: Response){
    ...
    const mailContentHTML = fs.readFileSync("/home/ubuntu/backend/templates/signupConfirmation.html", 'utf-8')
    const mailContentRaw = fs.readFileSync("/home/ubuntu/backend/templates/signupConfirmation.txt", 'utf-8')
